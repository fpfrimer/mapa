...
6. Selecione a visão desejada (por período, professor ou sala) e escolha o item para visualizar.
...
8. O painel de edição sugere professores e salas livres naquele horário, indicando com destaque os docentes vinculados à disciplina escolhida e sinalizando quando o professor pertence à área do curso; conflitos continuam sendo validados ao salvar seleções múltiplas.
